...
export function openColumnModal() {
  ...
  plusColumnBtn.addEventListener("click", () => {
...
function buttonTemplate() {
  const buttonTemplate = `<div class="plus-x-button">
...
function columnContentTemplate(columnTitle) {
  const columContent = `<div class="${columnTitle}-content">
...
export function createColumnHTML(columnTitle) {
  return `<div class="container-title">
    ...
    ${buttonTemplate()}
    ${columnContentTemplate(columnTitle)}
  </div>
 `;
}
